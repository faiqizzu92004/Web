...
<div class="form-container">
    <form action="saveBarcode.php" method="post">
        <label for="rfidNumber">Barcode Number:</label>
        <input type="text" name="barcodeNo" id="barcodeNo" placeholder="Enter Barcode" required autofocus>
...
<div class="back-button-container">
    <a href="registrationBarcode.php" class="back-button">Back</a> <!-- Update "previous_page.php" to the actual page you want to return to -->
</div>
